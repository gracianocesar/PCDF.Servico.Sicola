...
{
    public partial class VwTempTempConfiguration : IEntityTypeConfiguration<VwTempTemp>
    {
        public void Configure(EntityTypeBuilder<VwTempTemp> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_temp_temp", "dbo");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwTempTemp> entity);
    }
}
