...
{
    public partial class VwCadavericoContundenteConfiguration : IEntityTypeConfiguration<VwCadavericoContundente>
    {
        public void Configure(EntityTypeBuilder<VwCadavericoContundente> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_cadaverico_contundente", "dbo");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwCadavericoContundente> entity);
    }
}
