...
{
    public partial class VwLaudoAntropologiaConfiguration : IEntityTypeConfiguration<VwLaudoAntropologia>
    {
        public void Configure(EntityTypeBuilder<VwLaudoAntropologia> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_laudo_antropologia", "dbo");

            entity.HasComment("Laudos da seção de antropologia forense");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwLaudoAntropologia> entity);
    }
}
