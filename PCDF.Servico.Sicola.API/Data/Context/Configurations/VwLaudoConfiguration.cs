...
{
    public partial class VwLaudoConfiguration : IEntityTypeConfiguration<VwLaudo>
    {
        public void Configure(EntityTypeBuilder<VwLaudo> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_laudo", "dbo");
            ...
            entity.Property(e => e.TituloTpLaudo)
                ...
                .HasComment("laudo de exame de corpo de delito etc");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<VwLaudo> entity);
    }
}
