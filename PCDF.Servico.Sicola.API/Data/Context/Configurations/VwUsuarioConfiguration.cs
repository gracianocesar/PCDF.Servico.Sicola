...
namespace PCDF.Servico.Sicola.API.Data.Context.Configurations
{
    public partial class VwUsuarioConfiguration : IEntityTypeConfiguration<VwUsuario>
    {
        public void Configure(EntityTypeBuilder<VwUsuario> entity)
        {
            ...
            entity.ToView("vw_usuario", "dbo");

            entity.HasComment("Usuários do SICOLA");
            ...
            entity.Property(e => e.NmCidadeResidencia)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("nm_cidade_residencia");

            entity.Property(e => e.NmEstadoResidencia)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("nm_estado_residencia");
