...
{
    public partial class VwPeritosConfiguration : IEntityTypeConfiguration<VwPeritos>
    {
        public void Configure(EntityTypeBuilder<VwPeritos> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_peritos", "dbo");

            entity.HasComment("Usuários que posuem acesso á área médica, e, portanto, são médicos legistas");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwPeritos> entity);
    }
}
