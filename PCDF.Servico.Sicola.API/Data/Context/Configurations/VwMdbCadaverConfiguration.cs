...
{
    public partial class VwMdbCadaverConfiguration : IEntityTypeConfiguration<VwMdbCadaver>
    {
        public void Configure(EntityTypeBuilder<VwMdbCadaver> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_mdb_cadaver", "dbo");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwMdbCadaver> entity);
    }
}
