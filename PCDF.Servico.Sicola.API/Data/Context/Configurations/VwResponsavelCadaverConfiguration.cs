...
{
    public partial class VwResponsavelCadaverConfiguration : IEntityTypeConfiguration<VwResponsavelCadaver>
    {
        public void Configure(EntityTypeBuilder<VwResponsavelCadaver> entity)
        {
            entity.HasNoKey();

            entity.ToView("vw_responsavel_cadaver", "dbo");
            ...
            entity.Property(e => e.CdResponsavel).HasColumnName("cd_responsavel");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VwResponsavelCadaver> entity);
    }
}
