...
{
    /// <summary>
    /// Esta consulta não foi feita no IML, provavelmente foi feita pela DITEC para interagir com o Millenium
    /// </summary>
    public partial class VwLaudoHomologadoDinf
    {
        public int? NrOcorrencia { get; set; }
        public int? AnoOcorrencia { get; set; }
        public int? CdOrgaoOcorrencia { get; set; }
        public int? OrgaoOcorrenciaDinf { get; set; }
